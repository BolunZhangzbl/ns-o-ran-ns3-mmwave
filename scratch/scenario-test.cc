...
static ns3::GlobalValue g_rlcAmEnabled ("rlcAmEnabled", "Enable RLC-AM",
                                        ns3::BooleanValue (false), ns3::MakeBooleanChecker ());

static ns3::GlobalValue g_dataRate ("dataRate", "Data Rate in Gb/s (e.g., 100 for 100Gb/s)",
                                    ns3::UintegerValue (100),
                                    ns3::MakeUintegerChecker<uint32_t> ());

static ns3::GlobalValue g_ues ("ues", "Number of UEs",
                               ns3::UintegerValue (3),
                               ns3::MakeUintegerChecker<uint32_t> ());
...
main (int argc, char *argv[])
{
  ...
  uint32_t configuration = uintegerValue.Get ();
  ...
  std::stringstream ss;
  ss << dataRateInt << "Gb/s";
  std::string dataRateStr = ss.str ();

  // Convert string to dataRate object
